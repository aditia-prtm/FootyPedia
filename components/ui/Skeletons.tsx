  ...
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 border-b border-[#2d2d2d] pb-6">
        <div className="space-y-3">
          <div className="h-4 w-36 rounded-lg bg-[#242424]" />
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[#2d2d2d]" />
            <div className="space-y-2">
              <div className="h-8 w-56 rounded-lg bg-[#2d2d2d]" />
              <div className="h-3.5 w-40 rounded-lg bg-[#242424]" />
            </div>
          </div>
        </div>
        <div className="h-10 w-64 rounded-xl bg-[#2d2d2d]" />
      </div>

      {/* Pill Toggle Skeleton */}
      <div className="h-11 w-56 rounded-2xl bg-[#1a1a1a] border border-[#2d2d2d]" />
